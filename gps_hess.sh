...
exiftool -api QuickTimeUTC -ee -G -overwrite_original -tagsFromFile /Users/jiechau/life_codes/exiftool_mac/gps_sample/gps_hess.mp4 -QuickTime:GPSCoordinates aaa.mp4 
